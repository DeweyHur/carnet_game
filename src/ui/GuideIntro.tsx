...
export default function GuideIntro({ cityId }: { cityId: string }) {
  ...
  const g = city.guide;
  const { shown, done, skip } = useTypewriter(t(g.intro), { speed, voice: 'guide', sound, animate: speed > 0 });
