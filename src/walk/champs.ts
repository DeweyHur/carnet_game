...
export const CURATED_CHAMPS: Curated[] = [
  { match: /arc de triomphe/i, name: '개선문', pos: [2.2950, 48.8738], cat: 'museum', emoji: '🏛️', known: true, star: true, cost: 16, mins: 60,
  ...
  { match: /champs-[ée]lys[ée]es/i, name: '샹젤리제 거리', pos: [2.3050, 48.8710], cat: 'sight', emoji: '🛣️', known: true, star: true, mins: 40,
    blurb: '개선문에서 콩코르드까지 1.9km 곧게 뻗은 대로. 위쪽 절반은 브랜드 매장과 사람, 아래쪽 절반은 갑자기 나무 그늘과 공원이 된다. 걸어 보면 생각보다 길다 — 끝까지 걸을 생각이면 30분은 잡아야 한다.' },
  { match: /petit palais/i, name: '프티 팔레', pos: [2.3147, 48.8661], cat: 'museum', emoji: '🖼️', star: true, cost: 0, mins: 70,
  ...
  { match: /jacquemart-andr[ée]/i, name: '자크마르앙드레 미술관', pos: [2.3105, 48.8757], cat: 'museum', emoji: '🕯️', star: true, cost: 17, mins: 80,
