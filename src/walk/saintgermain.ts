...
export const CURATED_SG: Curated[] = [
  { match: /shakespeare (and|&) co/i, name: '셰익스피어 앤드 컴퍼니', photo: ['Shakespeare and Company (bookstore)'], star: true, pos: [2.3470, 48.8526], cat: 'shop', emoji: '📚', known: true, mins: 25,
  ...
  { match: /jardin du luxembourg/i, name: '뤽상부르 정원', photo: ['Jardin du Luxembourg'], star: true, pos: [2.3372, 48.8467], cat: 'park', emoji: '🌳', known: true, mins: 40,
    blurb: '메디치의 마리가 피렌체를 그리며 만든 정원. 파리 사람들이 의자를 끌어다 아무 데나 놓고 앉는다. 연못에서 아이들이 막대로 미는 나무 돛단배를 빌릴 수 있다.' },
  { match: /panth[ée]on/i, name: '팡테옹', photo: ['Panthéon'], star: true, pos: [2.3464, 48.8462], cat: 'museum', emoji: '🏛️', known: true, cost: 13, mins: 70,
