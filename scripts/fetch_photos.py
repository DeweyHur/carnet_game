...
TARGETS = {
    'prague': ('File:North view of Charles Bridge from Mánesův most, Prague 20160808 1.jpg', 'Charles Bridge · Prague'),
    'prague:square': ('File:Prague Old Town Square, Czech Republic - Oct 2010.jpg', 'Old Town Square · Prague'),
    'vienna': ("St. Stephen's Cathedral, Vienna", 'Stephansdom · Vienna'),
    'vienna:belvedere': ('Belvedere, Vienna', 'Belvedere · Vienna'),
    'bratislava': ('Bratislava Castle', 'Bratislava Castle'),
    'bratislava:blue': ('Blue Church', 'Blue Church · Bratislava'),
    'budapest': ('Hungarian Parliament Building', 'Parliament · Budapest'),
    'budapest:bridge': ('Széchenyi Chain Bridge', 'Chain Bridge · Budapest'),
    'krakow': ('Main Square, Kraków', 'Main Market Square · Kraków'),
    'krakow:wawel': ('Wawel Castle', 'Wawel Castle · Kraków'),
    'warsaw': ('Old Town Market Place, Warsaw', 'Old Town Market Place · Warsaw'),
    'warsaw:park': ('Łazienki Park', 'Łazienki Park · Warsaw'),
    'ljubljana': ('Triple Bridge', 'Triple Bridge · Ljubljana'),
    'ljubljana:dragon': ('Dragon Bridge (Ljubljana)', 'Dragon Bridge · Ljubljana'),
    'bucharest': ('Romanian Athenaeum', 'Romanian Athenaeum · Bucharest'),
    'bucharest:old-town': ('Stavropoleos Monastery', 'Stavropoleos · Bucharest'),
    'zagreb': ('Zagreb Cathedral', 'Zagreb Cathedral'),
    'zagreb:upper-town': ("St. Mark's Church, Zagreb", "St Mark's Church · Zagreb"),
    'belgrade': ('Belgrade Fortress', 'Belgrade Fortress · Kalemegdan'),
    'belgrade:skadarlija': ('Skadarlija', 'Skadarlija · Belgrade'),
    'sofia': ('Alexander Nevsky Cathedral, Sofia', 'Alexander Nevsky Cathedral · Sofia'),
    'sofia:rotunda': ('Church of St George, Sofia', 'Church of St George · Sofia'),
    'vilnius': ('Vilnius Cathedral', 'Vilnius Cathedral'),
    'vilnius:uzupis': ('Užupis', 'Užupis · Vilnius'),
    'riga': ("File:House of Blackheads at Dusk 3, Riga, Latvia - Diliff.jpg", 'House of the Blackheads · Riga'),
    'riga:market': ('Riga Central Market', 'Riga Central Market'),
