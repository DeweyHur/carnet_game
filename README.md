# 카르네(Carnet): 세계를 걷는 기록 — 국경 너머 업데이트
...
- 국경 너머(런던·브뤼셀·쾰른·제네바·바르셀로나) 5개 도시와 다중 통화(GBP/CHF) 결제, 라이벌 테오 이벤트 적용 완료.
- 유럽 전역 확장(독일·스페인 내 소도시, 이탈리아·베네룩스), 아시아·북미 허브, 계정·클라우드 세이브(FastAPI)
